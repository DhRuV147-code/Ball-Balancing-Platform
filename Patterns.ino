...
//stepper motors
AccelStepper stepperA(1, 2, 3);  //(driver type, STEP, DIR) Driver A
AccelStepper stepperB(1, 4, 5);  //(driver type, STEP, DIR) Driver B
AccelStepper stepperC(1, 6, 7);  //(driver type, STEP, DIR) Driver C
